...
{
    @Inject
    Version1To2UpgradeSchemaAppJob(IConnectionContext connContext, ISchemaDetector schemaDetector, ISchemaDuty schemaDuty)
    {
        super("Upgrade data schema at version 1 to 2", connContext, schemaDetector, schemaDuty, 1, 2, "migration-sql-1-to-2.sql", null);
    }
}
