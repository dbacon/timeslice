...
public class BaseLowLevelOrderingWorks
{
    ...
    public ConnectionWork<List<String>> workGetSet(final String setName)
    {
    ...
    public final ConnectionWork<Void> workInsertElementOfSet(final String setName, final int i, final String member)
    {
    ...
    public final ConnectionWork<Void> workInsertSet(final String setName, final List<String> orderedSetMembers)
    {
        return new ConnectionWork<Void>()
        {
            @Override
    ...
    public final ConnectionWork<Void> workDeleteSetByName(final String setName)
    {
        return new ConnectionWork<Void>()
        {
            @Override
