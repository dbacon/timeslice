...
public class HsqldbTagWorks implements ITagWorks
{
    ...
    @Override
    public ConnectionWork<String> workLookupBillee(final String description, final DateTime asOf, final String valueOnMiss)
    {
        return new ConnectionWork<String>()
        {
            @Override
    ...
    @Override
    public ConnectionWork<Void> workAssignBillee(final String description, final String billee, final DateTime date)
    {
    ...
    @Override
    public ConnectionWork<Void> workEndDateAnyBillee(final String description, final DateTime untilDate)
    {
        return new ConnectionWork<Void>()
        {
            @Override
    ...
    @Override
    public ConnectionWork<Void> workInsertBillee(final String description, final String billee, final DateTime asOf)
    {
        return new ConnectionWork<Void>()
        {
            @Override
    ...
    @Override
    public ConnectionWork<List<String>> workGetAllBillees()
    {
