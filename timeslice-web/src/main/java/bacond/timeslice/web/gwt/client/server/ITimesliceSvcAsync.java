...
public interface ITimesliceSvcAsync
{
	...
	void refreshTotals(String authToken, int maxSize, SortDir sortDir, ProcType procType, String startingInstant, String endingInstant, AsyncCallback<List<TaskTotal>> callback);
    ...
    void persistTotals(String authToken, String persistAsName, int maxSize, SortDir sortDir, ProcType procType, String startingInstant, String endingInstant, AsyncCallback<String> callback);
}
