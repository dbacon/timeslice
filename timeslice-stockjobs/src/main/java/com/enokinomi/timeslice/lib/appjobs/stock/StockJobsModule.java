...
//        appJobSetBinder.addBinding().to(Version4To3DowngradeSchemaAppJob.class);
        appJobSetBinder.addBinding().to(Version6To5DowngradeSchemaAppJob.class);
        ...
        appJobSetBinder.addBinding().to(Version4To5UpgradeSchemaAppJob.class);
        appJobSetBinder.addBinding().to(Version5To6UpgradeSchemaAppJob.class);
    }
