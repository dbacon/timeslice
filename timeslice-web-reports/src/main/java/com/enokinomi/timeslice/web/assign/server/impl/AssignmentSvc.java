...
public class AssignmentSvc
{
    ...
    public List<AssignedTaskTotal> refreshAssignedTotals(String user, int maxSize, SortDir sortDir, String startingInstant, String endingInstant, List<String> allowWords, List<String> ignoreWords)
    {
