...
import com.enokinomi.timeslice.web.report.client.core.IReportsSvcAsync;
...
public class ReportPresenter implements IReportPresenter
{
    ...
    private final IReportsSvcAsync reportsSvc;
    ...
    @Inject
    public ReportPresenter(IAssignmentSvcAsync assignSvc, ILoginSupport loginSupport, IReportsSvcAsync reportsSvc)
    {
    ...
    public void startRefreshTotals(final int maxSize, final SortDir sortDir, final String startingInstant, final String endingInstant, final List<String> allowWords, final List<String> ignoreWords)
    {
        new IOnAuthenticated()
        {
            ...
            {
                reportsSvc.refreshTotals(loginSupport.getAuthToken(),
